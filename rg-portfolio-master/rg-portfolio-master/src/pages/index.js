...
const IndexPage = ({ data }) => (
	<Layout header="home">
		<SEO title={data.contentfulAboutMe.designation} keywords={[`Rohit Gupta`, `Frontend Developer`, `Developer`]} />
		...
		{data.contentfulSiteInformation.menus
			...
			.map((t) => {
				return <Testimonial data={data.allContentfulTestimonials}></Testimonial>;
			})}
